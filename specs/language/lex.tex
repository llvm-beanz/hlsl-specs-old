\chapter{Lexical Conventions} \label{ch:Lex}

\section{Unit of Translation} \label{sec:Translation}
...
\section{Phases of Translation} \label{sec:Phases}
...
\begin{enumerate}
  ...
  \item Any sequence of backslash (\texttt{\\}) immediately followed by a new
  line is deleted, resulting in splicing lines together.
